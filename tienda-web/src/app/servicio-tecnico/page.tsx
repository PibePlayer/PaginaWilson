...
export default function ServicioTecnicoPage() {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hola! Quisiera hacer una consulta sobre el Servicio Técnico."
  );
      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="max-w-2xl">
          ...
          <p className="mt-4 font-proxima text-base leading-7 text-zinc-600">
            Puede contactarnos directamente por WhatsApp describiendo su problema o
            acercarse a nuestro local para recibir asistencia técnica especializada.
          </p>
        </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 font-proxima text-sm leading-6 text-zinc-600">
                Describa su problema técnico, y un especialista de nuestro equipo lo asistirá a la brevedad.
              </p>
